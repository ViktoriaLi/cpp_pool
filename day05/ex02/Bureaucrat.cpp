...
{
  if (form.getGradeS() >= this->_grade && !form.getiIfSigned())
    std::cout << "<" << this->_name << ">" << " signs "  << "<" << form.getName() << ">" << std::endl;
  else if (form.getGradeS() < this->_grade)
    std::cout << "<" << this->_name << ">" << " cannot sign "  << "<" << form.getName()
    << ">" << " because he has low grade" << std::endl;
  else if (form.getiIfSigned())
  std::cout << "<" << this->_name << ">" << " cannot sign "  << "<" << form.getName()
...
{
  if (form.getGradeE() >= this->getGrade() && form.getiIfSigned())
